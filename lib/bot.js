...
class Bot {
  ...
  sendToDiscord(author, channel, text) {
    ...
    if (author.toLowerCase().includes('mmx') && (text.includes('yande.re') || text.includes('twitter.com') || text.includes('lolibooru') || text.includes('4cdn.org') || text.includes('paheal.net') || text.includes('4cdn.org') || text.includes('twimg.com'))) {
      return;
    }
